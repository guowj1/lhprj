...
public class VoucherPlugin extends AbstractPfxxPlugin implements IVoucherSave, IVoucherDelete {
	...
	private Object doSaveVoucher(VoucherVO vo, ISwapContext con, AggxsysregisterVO xsysvo,int voucherNum) throws GLBusinessException {
		String returnvoucherid = "00000000";
			...
			//gwj add
//			UFDateTime dtNow=new UFDateTime(new Date(TimeService.getInstance().getTime()));
//			for(Object detailvo:vouchervo.getDetail()){
//				DetailVO dtVO=(DetailVO) detailvo;
//				dtVO.setTs(dtNow);
//			}
