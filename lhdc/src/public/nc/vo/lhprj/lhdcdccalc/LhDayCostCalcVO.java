...
public class LhDayCostCalcVO extends SuperVO {
...
/**
* 属性pk_dccalc的Setter方法.属性名：主键
* 创建日期:2017-7-6
* @param newPk_dccalc java.lang.String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("lhprj.LhDayCostCalc");
    }
   }
