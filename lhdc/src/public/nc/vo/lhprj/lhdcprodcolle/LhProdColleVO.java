...
public class LhProdColleVO extends SuperVO {
...
/**
* 属性 pk_prodcolle的Getter方法.属性名：主键
*  创建日期:2017-7-4
...
/**
* 属性pk_prodcolle的Setter方法.属性名：主键
* 创建日期:2017-7-4
* @param newPk_prodcolle java.lang.String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("lhprj.LhProdColle");
    }
   }
