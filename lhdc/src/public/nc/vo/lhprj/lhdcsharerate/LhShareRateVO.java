...
public class LhShareRateVO extends SuperVO {
...
/**
* 属性 pk_sharerate的Getter方法.属性名：主键
*  创建日期:2017-6-18
...
/**
* 属性pk_sharerate的Setter方法.属性名：主键
* 创建日期:2017-6-18
* @param newPk_sharerate java.lang.String
*/
...
/**
* 属性 pk_org_v的Getter方法.属性名：业务单元版本
*  创建日期:2017-6-18
* @return nc.vo.vorg.CorpVersionVO
*/
...
/**
* 属性pk_org_v的Setter方法.属性名：业务单元版本
* 创建日期:2017-6-18
* @param newPk_org_v nc.vo.vorg.CorpVersionVO
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("lhprj.LhShareRate");
    }
   }
