...
public class IngredientHVO extends SuperVO {
...
/**
* 属性 pk_ingredient_h的Getter方法.属性名：主键
*  创建日期:2017-7-7
...
/**
* 属性pk_ingredient_h的Setter方法.属性名：主键
* 创建日期:2017-7-7
* @param newPk_ingredient_h java.lang.String
*/
...
/**
* 属性 pk_stordoc的Getter方法.属性名：入库仓库
*  创建日期:2017-7-7
...
/**
* 属性pk_stordoc的Setter方法.属性名：入库仓库
* 创建日期:2017-7-7
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("lhprj.hingredient");
    }
   }
