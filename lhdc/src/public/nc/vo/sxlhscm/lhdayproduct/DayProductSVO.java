...
public class DayProductSVO extends SuperVO {
	
/**
*子表主键
*/
public String pk_dayproduct_s;
/**
*物料
*/
...
/**
* 属性 pk_dayproduct_s的Getter方法.属性名：子表主键
*  创建日期:2017-7-7
* @return java.lang.String
*/
public String getPk_dayproduct_s() {
return this.pk_dayproduct_s;
} 

/**
* 属性pk_dayproduct_s的Setter方法.属性名：子表主键
* 创建日期:2017-7-7
* @param newPk_dayproduct_s java.lang.String
*/
public void setPk_dayproduct_s ( String pk_dayproduct_s) {
this.pk_dayproduct_s=pk_dayproduct_s;
} 
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("lhprj.sdayproduct");
    }
   }
